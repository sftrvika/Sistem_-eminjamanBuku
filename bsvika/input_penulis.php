...
<div class=" card mb-3">
            <div class="card-body">
              <div class="table-responsive">
                ...
                <td width="500">
                  <form method="post" action="prosespenulis.php" enctype="multipart/form-data">
                   
                     <div class="from-group">
                      <label for="usr">Nama Penulis :</label>
                      <input type="text" class="form-control" name="nama_penilus" required=""></label>
                    </div>
                     <div class="from-group">
                      <label for="usr">Tgl Lahir :</label>
                      <input type="date" class="form-control" name="tgl_lahir" required=""></label>
                  </div>
                    <div class="from-group">
